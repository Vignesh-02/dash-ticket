...
import { createTicket } from "@/app/actions/tickets.actions";
      ...
      return (
        <div className='w-full max-w-md bg-white shadow-md rounded-lg p-8 border border-gray-200'>
          ...
          <form action={formAction} className='space-y-4 text-gray-700'>
            ...
            <button
              className='w-full bg-blue-600 text-white p-3 rounded cursor-pointer hover:bg-blue-700 transition disabled:opacity-50'
              type='submit'
            >
              Submit
            </button>
