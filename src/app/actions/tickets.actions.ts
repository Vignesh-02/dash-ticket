...
export async function deleteTicket(
    ...
    try {
        ...
        logEvent("Ticket deleted successfully", "ticket", { ticketId }, "info");

        revalidatePath("/tickets");

        return { success: true, message: "Ticket deleted successfully" };
    } catch (error) {
        logEvent("Error deleting ticket", "ticket", {}, "error", error);
...
export async function updateTicket(
    ...
    try {
        ...
        logEvent("Ticket updated successfully", "ticket", { ticketId }, "info");
        ...
        logEvent("Error updating ticket", "ticket", {}, "error", error);
